...
/*
Frank Pulido - Tema 2 [PHP BÁSICO] - Nivel 2 - Ejercicio 2
Material del curso :
...
do {
    ...
    do {
        ...
        if($opcion2 != 1 && $opcion2 != 0) {echo "La opción seleccionada no es válida. Introduzca de nuevo su opción :" . PHP_EOL;} // Alternativa a \n
